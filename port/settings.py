...
SECRET_KEY = 'django-insecure-vl35+eb1^-!o#(=5kvlkt**6wazzn5_^pjx(u$bhh-4z2_z$ei'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'filio', 'static')]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'filio', 'media')  # Or move it to BASE_DIR
